...
deviceType[1].addEventListener('touchcancel', ()=>{
    deviceType[1].classList.remove("smart");
});
...
deviceType[2].addEventListener('touchcancel', ()=>{
    deviceType[2].classList.remove("smart");
});
...
deviceType[3].addEventListener('touchcancel', ()=>{
    deviceType[3].classList.remove("smart");
});
...
deviceType[4].addEventListener('touchcancel', ()=>{
    deviceType[4].classList.remove("smart");
});
...
deviceType[5].addEventListener('touchcancel', ()=>{
    deviceType[5].classList.remove("smart");
});
...
deviceType[6].addEventListener('touchcancel', ()=>{
    deviceType[6].classList.remove("smart");
});
...
deviceType[7].addEventListener('touchcancel', ()=>{
    deviceType[7].classList.remove("smart");
});
